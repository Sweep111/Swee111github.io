...
base='kodisweepswizard'
ADDON=xbmcaddon.Addon(id='plugin.program.kodisweeps')
    
    
VERSION = "1.0.1"


PATH = "kodi sweeps wizard"            

dp           =  xbmcgui.DialogProgress()
dialog       =  xbmcgui.Dialog()
EXCLUDES     = ['plugin.program.kodisweeps']
HOME         =  xbmc.translatePath('special://home/')

    
def CATEGORIES():
    link = OPEN_URL('http://httpskodisweepssweepscom.000webhostapp.com/sweepbuild/wizard.txt').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp = xbmcgui.DialogProgress()
    dp.create("kodi sweeps wizard","Wizard is Whizzing down your Wires ",'', 'Put the kettle on')
    ...
    time.sleep(2)
    dp.update(0,"", "Extracting Kodi sweeps now, Please Wait")
    print '======================================='
    print addonfolder
    print '======================================='
...
def addDir(name,url,mode,iconimage,fanart,description):
        ...
        ok=True
        liz=xbmcgui.ListItem(name, iconImage="https://imgmak.com/images/2018/01/08/freshstart.png", thumbnailImage=iconimage)
...
def FRESHSTART(params):
    ...
    choice2 = xbmcgui.Dialog().yesno("Are you sure?", 'Are you sure you want to wipe this install?', '', 'All addons EXCLUDING kodi sweeps wizard will be completely wiped!', yeslabel='Yes',nolabel='No')
    if choice2 == 0:
        return
    elif choice2 == 1:
